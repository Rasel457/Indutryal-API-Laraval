...
export default function FinanceFinancialReport(){
    setPageTitle("Report | Financial");
    ...
    useGet(API+'financereportfinancials/'+localStorage.getItem('id'),setReports);

    const onReportGenerate = async ()=>{
        await axios.get(API+"financereportgeneratefinancial/"+localStorage.getItem('id'), { headers: { 'Access-Control-Allow-Origin': '*', 'Accept' : 'application/json', 'user_type':localStorage.getItem('type') } })
        ...
        <div>
            ...
            <div align="center" style={{paddingTop:"20px"}}>
                <Card style={{ width: '70rem', height:'40rem' }}>
                    <Card.Header>Report - Financial</Card.Header>
